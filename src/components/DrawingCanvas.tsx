...
export default function DrawingCanvas({
  ...
  // Add touch boundary detection (moved before gesture handlers)
  ...
  return (
    <View style={{ backgroundColor: 'white', borderRadius: 8, borderWidth: 1, borderColor: '#d1d5db' }} collapsable={false}>
      <GestureDetector
        gesture={gestures}
      >
        <Canvas style={{ backgroundColor: "#fafafa", width, height }} onTouch={touchHandler}>
      ...
      >
        <View style={{ flex: 1, backgroundColor: 'rgba(0, 0, 0, 0.5)', justifyContent: 'center', alignItems: 'center' }}>
          <View style={{ backgroundColor: 'white', borderRadius: 12, padding: 20, marginHorizontal: 20, minWidth: 300, maxWidth: 400 }}>
            <RNText style={{ fontSize: 16, fontWeight: 'bold', color: '#1f2937', marginBottom: 12 }}>Enter Text:</RNText>
            <TextInput
              style={{ borderWidth: 1, borderColor: '#d1d5db', borderRadius: 8, padding: 12, fontSize: 16, color: '#1f2937', backgroundColor: '#f9fafb', marginBottom: 16 }}
            ...
            <View style={{ flexDirection: 'row', gap: 12 }}>
              <TouchableOpacity
                style={{ flex: 1, paddingVertical: 12, paddingHorizontal: 16, borderRadius: 8, backgroundColor: '#f3f4f6', borderWidth: 1, borderColor: '#d1d5db', alignItems: 'center' }}
                onPress={handleTextCancel}
              >
                <RNText style={{ color: '#374151', fontSize: 16, fontWeight: '500' }}>Cancel</RNText>
              </TouchableOpacity>
              <TouchableOpacity
                style={{ flex: 1, paddingVertical: 12, paddingHorizontal: 16, borderRadius: 8, backgroundColor: '#3b82f6', alignItems: 'center' }}
                onPress={handleTextSubmit}
              >
                <RNText style={{ color: 'white', fontSize: 16, fontWeight: '500' }}>Add Text</RNText>
              </TouchableOpacity>
            </View>
          </View>
        </View>
